...
def detect_swipe(hand_landmarks):
    ...
    # Determine direction of swipe based on wrist and index finger movement
    if wrist.x - index_tip.x > 0.1:  # Swipe left
        return 'left'
    elif index_tip.x - wrist.x > 0.1:  # Swipe right
        return 'right'
    return None  # No swipe detected
